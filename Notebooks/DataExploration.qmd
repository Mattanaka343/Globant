...
data.to_csv('../Data/data_globant_clean.csv', index=False)
```
...
Los valores obtenidos a partir de describe resultan utiles pero sería mas conveniente visualizarlos de forma más clara en gráficas de barras o boxplots
...
Pasando al boxplot podemos observar una cantidad significativa de outliers en los valores mas bajos del engagement mostrando que hay un 
...
```
A partir de esta grafica es fácil distinguir al mes de enero como el mes más productivo de los registros
